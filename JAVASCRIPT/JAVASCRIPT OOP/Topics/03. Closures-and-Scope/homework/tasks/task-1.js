...
function solve() {
    ...
    var library = (function () {
        ...
        function listBooks(givenBook) {
            if (givenBook && givenBook.category) {
                return books.filter(function (el) {
                    return el.category === givenBook.category;
                });
            }

            if (givenBook && givenBook.author) {
                return books.filter(function (el) {
                    return el.author === givenBook.author;
                });
            }
        ...
        function addBook(book) {
            ...
            if (!(categories.some(function (currCat) {
                    return currCat === book.category;
                }))) {
