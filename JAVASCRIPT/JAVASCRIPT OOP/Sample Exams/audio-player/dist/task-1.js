...
function solve() {
    ...
    var playlist,
        ...
        validateNumber: function validateNumber(val, name) {
            name = name || 'Value';
            if (val === undefined) {
                throw new Error(name + ' cannot be undefined');
            }
        ...
        validatePaging: function validatePaging(page, size, maxElements) {
    ...
    playlist = function () {
        ...
        Object.defineProperty(playlist, 'listPlayables', {
            value: function value(page, size) {
                ...
                return this._playables.slice(0).sort(function (a, b) {
                    if (a.name < b.name) {
                        return -1;
                    }
                    if (a.name > b.name) {
    ...
    player = function () {
        ...
        Object.defineProperty(player, 'addPlaylist', {
            value: function value(playlistToAdd) {
        ...
        Object.defineProperty(player, 'listPlayables', {
            value: function value(page, size) {
                ...
                return playables.slice(0).sort(function (a, b) {
                    if (a.name < b.name) {
                        return -1;
                    }
                    if (a.name > b.name) {
