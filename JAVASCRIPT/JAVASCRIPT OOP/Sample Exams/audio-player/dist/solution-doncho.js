...
function solve() {
    ...
    var player = function () {
        ...
        var player = {
            ...
            removePlaylist: function removePlaylist(value) {
                var id = value;
            ...
            listPlaylists: function listPlaylists(page, size) {
                /*
                    page*size > COUNT_OF_PLAYABLE_IN_PLAYLIST
                    page < 0
                    size <= 0
                */
                if (typeof page === 'undefined' || typeof size === 'undefined' || page < 0 || size <= 0 || page * size > this.playlists.length) {
                    throw {
    ...
    var playlist = function () {
        ...
        var playlist = {
            ...
            getAllPlayables: function getAllPlayables() {
                return this.playables.slice();
            },
            addPlayable: function addPlayable(playable) {
            ...
            getPlayableById: function getPlayableById(id) {
                var i, len;
                // for(playable of this.playables){
            ...
            removePlayable: function removePlayable(value) {
                var id = value;
                if (typeof value === 'undefined') {
                    throw {
                        name: 'InvalidIdError',
            ...
            listPlayables: function listPlayables(page, size) {
                /*
                    page*size > COUNT_OF_PLAYABLE_IN_PLAYLIST
                    page < 0
                    size <= 0
    ...
    var playable = function () {
        var lastId = 0,
            playable = {
            init: function init(title, author) {
                this.id = lastId += 1;
                this.title = title;
                this.author = author;
                return this;
    ...
    var video = function (parent) {
        ...
        Object.defineProperty(video, 'imdbRating', {
            ...
            set: function set(newImdbRating) {
...
var player = _module.getPlayer('John\'s Player');
var playlist = _module.getPlaylist('The BG');

playlist.addPlayable(_module.getAudio('Te sa zeleni', 'Keranov', 3.37)).addPlayable(_module.getAudio('Te sa cherni', 'Chernio', 45));
player.addPlaylist(playlist);

var playlist2 = _module.getPlaylist('GOsho\' Playlist');
playlist2.addPlayable(_module.getAudio('Te sa zeleni', 'Keranov', 3.37));
