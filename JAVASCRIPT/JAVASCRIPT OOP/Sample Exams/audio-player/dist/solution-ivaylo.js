...
function solve() {
    var module = function () {
        ...
        validator = {
            validateIfUndefined: function validateIfUndefined(val, name) {
                name = name || 'Value';
                if (val === undefined) {
                    throw new Error(name + ' cannot be undefined');
                }
            },
            validateIfObject: function validateIfObject(val, name) {
                name = name || 'Value';
                if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) !== 'object') {
                    throw new Error(name + ' must be an object');
                }
            },
            validateIfNumber: function validateIfNumber(val, name) {
                name = name || 'Value';
                if (typeof val !== 'number') {
                    throw new Error(name + ' must be a number');
                }
            },
            validateString: function validateString(val, name) {
                name = name || 'Value';
            ...
            validatePositiveNumber: function validatePositiveNumber(val, name) {
                name = name || 'Value';
                this.validateIfUndefined(val, name);
            ...
            validatePageAndSize: function validatePageAndSize(page, size, maxElements) {
        ...
        player = function () {
            ...
            Object.defineProperty(player, 'listPlaylists', {
                value: function value(page, size) {
                    validator.validatePageAndSize(page, size, this._playlists.length);

                    return this._playlists.slice().sort(getSortingFunction('name', 'id')).splice(page * size, size);
                }
            });

            Object.defineProperty(player, 'contains', {
                value: function value(playable, playlist) {
                ...
                value: function value(pattern) {
                    ...
                    return this._playlists.filter(function (playlist) {
                        return playlist.listPlayables().some(function (playable) {
                            return playable.length !== undefined && playable.title.toLowerCase().indexOf(pattern.toLowerCase()) >= 0;
                        });
        ...
        playlist = function () {
            ...
            Object.defineProperty(playlist, 'listPlayables', {
                value: function value(page, size) {
                    ...
                    return this._playables.slice().sort(getSortingFunction('title', 'id')).splice(page * size, size);
                }
            });
        ...
        playable = function () {
            ...
            Object.defineProperty(playable, 'init', {
                value: function value(title, author) {
                    this.title = title;
                    this.author = author;
        ...
        audio = function (parent) {
            ...
            Object.defineProperty(audio, 'init', {
                value: function value(title, author, length) {
        ...
        video = function (parent) {
            ...
            Object.defineProperty(video, 'init', {
                value: function value(title, author, imdbRating) {
                    parent.init.call(this, title, author);
...
player = _module.getPlayer('pesho');
playlist = _module.getPlaylist('gosho');
player.addPlaylist(playlist);
var audio = _module.getAudio('ivan', 'ivanov', 4);
